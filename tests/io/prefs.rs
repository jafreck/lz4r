...
use lz4::io::prefs::{
    ...
    DISPLAY_LEVEL, KB, LZ4IO_BLOCKSIZEID_DEFAULT, LZ4IO_MAGICNUMBER, LZ4IO_SKIPPABLE0,
    LZ4IO_SKIPPABLEMASK, LEGACY_BLOCKSIZE, LEGACY_MAGICNUMBER, MAGICNUMBER_SIZE, MB,
    MIN_STREAM_BUFSIZE, REFRESH_RATE_NS, GB, CACHELINE, LZ4_MAX_DICT_SIZE,
};
...
fn skippable_mask_matches_skippable0_family() {
    ...
    assert_eq!((LZ4IO_SKIPPABLE0 + 0xF) & LZ4IO_SKIPPABLEMASK, LZ4IO_SKIPPABLE0);
}
